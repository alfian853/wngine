        ...
        <div class="col-md-12 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('post.member.password.reset') }}" role="form">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}" >
                            ...
                            <div class="col-md-12">
                                <input id="password_old"  type="password" class="form-control" name="password_1" required>
                                @if ($errors->has('email'))
